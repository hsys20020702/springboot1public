package me.shinsunyoung.springbootdeveloper.domain.controller.config.jwt;

import io.jsonwebtoken.Jwt;
import io.jsonwebtoken.Jwts;
import me.shinsunyoung.springbootdeveloper.domain.config.jwt.JwtProperties;
import me.shinsunyoung.springbootdeveloper.domain.config.jwt.TokenProvider;
...
public class TokenProviderTest {
    ...
    @DisplayName("validToken(): 만료된 토큰일 떄에 유효성 검증에 실패한다.")
    @Test
